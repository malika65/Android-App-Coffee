...
class AccessorsAdapter(private val colors: List<Accessors>)
    : RecyclerView.Adapter<AccessorsAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun setPostImageView(postItem: Accessors) {
            img.setImageResource(postItem.imgAccessors)
        }
