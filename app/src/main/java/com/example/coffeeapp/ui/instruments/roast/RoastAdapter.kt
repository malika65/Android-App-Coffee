...
class RoastAdapter(private val colors: List<Roast>)
    : RecyclerView.Adapter<RoastAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun setPostImageView(postItem: Roast) {
            img.setImageResource(postItem.imgRoast)
        }
