...
class MolAdapter(private val colors: List<CoffeeMol>)
    : RecyclerView.Adapter<MolAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun setPostImageView(postItem: CoffeeMol) {
            img.setImageResource(postItem.imgMol)
        }
